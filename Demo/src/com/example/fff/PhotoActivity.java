...
public class PhotoActivity extends Activity {
	...
	private void initView() {
		...
		changeTheme();
		File file = new File(PhotoActivity.this.getFilesDir(), "_head_icon.jpg");
		if (file.exists()) {
	...
	private void changeHeadIcon() {
		...
		AlertDialog dlg = new AlertDialog.Builder(PhotoActivity.this)
				.setTitle("选择图片")
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == PHOTO_REQUEST_GALLERY) {
			...
			if (Environment.getExternalStorageState().equals(
				...
				Toast.makeText(PhotoActivity.this, "未找到存储卡，无法存储照片！",
			...
			if (data != null) {
				...
				try {
					...
					outputStream = PhotoActivity.this.openFileOutput(
